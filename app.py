...
try:
    ...
    CV2_AVAILABLE = False
    print("⚠ Computer vision disabled")
...
def submit_interview(current_user, job_id):
    try:
        ...
        overall_score = (confidence * 0.3 + avg_keyword * 0.5 + (avg_sentiment + 1) * 50 * 0.2)
...
def index():
    return jsonify({'message': 'SOULCRUIT AI Backend', 'version': '5.0', 'status': 'running'}), 200
